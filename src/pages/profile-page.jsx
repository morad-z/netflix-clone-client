...
export default function ProfilePage() {
  ...
  const setActiveProfileMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      localStorage.setItem("activeProfileId", data.activeProfileId.toString());
      ...
      // Navigate to home page after a short delay to ensure session is saved
      console.log("Navigating to home page after profile selection");
      setTimeout(() => {
        setLocation("/");
      }, 1000);
    },
  ...
  const handleProfileSelect = (profile) => {
    if (isRedirecting) return; // Prevent multiple selections
